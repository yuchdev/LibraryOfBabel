...
from babel_poc.config import DEFAULT_CACHE_DIR, DEFAULT_MANIFEST, DEFAULT_VOCAB_DIR
from babel_poc.vocabulary.manifest import InstalledVocabulary, load_manifest, register_vocabulary
from babel_poc.vocabulary.sources import KNOWN_VOCABULARY_SOURCES, VocabularySource
...
def install_source(
    ...
    Returns the :class:`~babel_poc.vocabulary.manifest.InstalledVocabulary`
...
def _install_from_url(
    ...
    from babel_poc.vocabulary.downloader import download_file
